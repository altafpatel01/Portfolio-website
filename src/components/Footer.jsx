...
const Footer =()=> {
  return (
    <div className="flex md:hidden bg-[#0a192f] justify-center">
        <ul className='flex'>
          ...
          {/* <li className="w-[60px] hover:w-[64px] h-[60px] justify-center items-center bg-[#333333]">
            <a
              className=" w-full flex justify-center items-center text-gray-300"
              href="https://github.com/altafpatel01"
            >
          ...
          <li className="w-[60px] hover:w-[64px] h-[60px] justify-center items-center  bg-[#6fc2b0]">
            <a
              className=" w-full flex justify-center items-center text-gray-300"
              href="mailto:altafpatel8485@gmail.com"
            >
          ...
          <li className="w-[60px] hover:w-[64px] h-[60px] justify-center items-center  bg-[#565f69]">
            <a
              className=" w-full flex justify-center items-center text-gray-300"
              href="/"
            >
